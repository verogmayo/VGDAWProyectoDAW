...
- [MariaDB](#mariadb)
        ...
        - [Configurar Acceso Remoto en el fichero de configuración MariaDB(donde está definido el puerto: port=3306)](#configurar-acceso-remoto-en-el-fichero-de-configuración-mariadbdonde-está-definido-el-puerto-port3306)
        - [Comandos útiles del servicio](#comandos-útiles-del-servicio)
        - [Comprobación del puerto usado por el servidor](#comprobación-del-puerto-usado-por-el-servidor)
          - [Usando comandos del sistema](#usando-comandos-del-sistema)
          - [Ver con consola de MariaDB](#ver-con-consola-de-mariadb)
        - [Creación de un usuario administrador con contraseña](#creación-de-un-usuario-administrador-con-contraseña)
        - [Asegurar el servidor MariaDB](#asegurar-el-servidor-mariadb)
      ...
      - [1.6 Módulos PHP](#16-módulos-php)
        - [a) `php8.3-mysql`](#a-php83-mysql)
          ...
          - [Comparativa de módulos](#comparativa-de-módulos)
        ...
        - [`XDebug`](#xdebug)
          ...
          - [Configuración del módulo Xdebug](#configuración-del-módulo-xdebug)
          - [Permisos para los logs](#permisos-para-los-logs)
      - [1.1.5 XDebug](#115-xdebug)
        - [Instalación y configuración](#instalación-y-configuración)
        - [Verifica si Xdebug está instalado](#verifica-si-xdebug-está-instalado)
        - [Si no aparece, instalálo:](#si-no-aparece-instalálo)
      - [1.1.6 DNS](#116-dns)
      - [1.1.7 SFTP](#117-sftp)
...
Forma de conectarse de forma remota con el nuevo usuario: (fuera del cliente MariaDB)
